...
const flags: CountryVariantFlag[] = [
  { svg: <CzFlag />, link: 'movapp.cz', country: 'cs', language: 'English' },
  { svg: <SkFlag />, link: 'localhost:3000/bangla', country: 'sk', language: 'বাংলা' },
  { svg: <PlFlag />, link: 'localhost:3000/urdu', country: 'pl', language: 'اردو' },
];
